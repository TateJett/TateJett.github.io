        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-4">
              <HashLink to="/#about" className="text-gray-300 hover:text-white px-3 py-2 rounded-md">
                About
              </HashLink>
              <HashLink to="/#projects" className="text-gray-300 hover:text-white px-3 py-2 rounded-md">
                Projects
              </HashLink>
              {/* New Experience Link */}
              <HashLink to="/#experience" className="text-gray-300 hover:text-white px-3 py-2 rounded-md">
                Experience
              </HashLink>
              <HashLink to="/#contact" className="text-gray-300 hover:text-white px-3 py-2 rounded-md">
                Contact
              </HashLink>
